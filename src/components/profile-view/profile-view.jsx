...
export default class ProfileView extends React.Component {
  ...
  onRemoveFavorite = (movie) => {
    ...
    axios
      .delete(
        `https://site--popkorny--w5mfxztkv9bc.code.run/users/${username}/movies/${movie}`,
  ...
  getUser = (token) => {
    const Username = localStorage.getItem("user");
    axios
      .get(`https://site--popkorny--w5mfxztkv9bc.code.run/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        this.setState({
  ...
  handleSubmit = (e) => {
    ...
    axios
      .put(
        `https://site--popkorny--w5mfxztkv9bc.code.run/users/${Username}`,
        {
  ...
  onDeleteUser() {
    ...
    axios
      .delete(`https://site--popkorny--w5mfxztkv9bc.code.run/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        console.log(response);
